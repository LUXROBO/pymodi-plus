...
Python 3.13에서 flake8이 `importlib_metadata`의 새로운 API와 호환되지 않아 다음 오류 발생:
...
**Python 3.8-3.12**: flake8 사용
```yaml
- name: Install dependencies (Python 3.8-3.12)
